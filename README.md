...
Sou Programador Júnior na empresa Fotosensores LTDA, onde as minhas principais funções são: análise e desenvolvimento de integrações entre sistemas; padronização de documentações; automação e provisionamento de tarefas/sistemas. As principais ferramentas que eu utilizo para desempenhar os itens citados, em sua maior parte são: Python; Sphinx, MkDocs, Ansible; Docker; NGINX e GNU/Linux.
